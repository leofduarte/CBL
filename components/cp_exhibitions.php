...
?>
   ...
   <div class="container-fluid">
      ...
      ?>
            ...
            <h1 style="color:#393166;" class="mt-5 ms-3">Nome da Exposição<?= $nome_exposicao ?></h1>

            <h3 style="color:#393166;" class="mt-5 ms-3">Obras da Exposição</h1>
      ...
      mysqli_close($link);
         ...
         <div class="container-fluid">
            ...
            <div style="border-radius: 2rem; background-color:#F4F2FF;" class="p-4 mb-5 mt-4">
               ...
               // Define the query
               $query = "SELECT id_exposicao, nome_exposicao, data_inicio, data_fim FROM exposicoes";
               ...
               if (mysqli_stmt_prepare($stmt, $query)) {
                  ...
                  if (mysqli_stmt_execute($stmt)) {
                     // Bind result variables
                     mysqli_stmt_bind_result($stmt, $id_exposicao, $nome, $inicio, $fim);
               ?>
                     <div style="border-radius: 2rem; background-color:#F4F2FF;" class="p-4 mb-5 mt-4">
                        <table class=" data_users mb-5 w-100 text-center">
                           <thead class="text-info" style="border-bottom: 1px solid grey">
                              <tr>
                                 ...
                                 <th class="px-4">Nº Obras</th>
                                 <th class="px-4">Início</th>
                                 <th class="px-4">Fim</th>
                              </tr>
                           </thead>
                           <tbody>
                           ...
                           <tr>
                              ...
                              <td class='my-3 px-4'>CONTAR NUMERO DE OBRAS</td>";

                                 if ($inicio == NULL) {
                                    echo "<td class='my-3 px-4 text-info'>---</td>";
                                 } else {
                                    echo " <td class='my-3 px-4 text-black'>$inicio</td>";
                                 }

                                 if ($fim == NULL) {
                                    echo "<td class='my-3 px-4 text-info'>---</td>";
                                 } else {
                                    echo " <td class='my-3 px-4 text-black'>$fim</td>";
                                 }
                                 echo "
                                 <td class='my-3 px-4'>
                                    <a href='./exposicoes.php?id=" . $id_exposicao . "'><i class='px-1 text-dark bi bi-pencil-square'></i>ver exposição</a>
                                 </td>
                              </tr>";
                              }
                              echo "</tbody>
