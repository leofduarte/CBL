...
?>
           <form action="./scripts/obras/sc_add_obras.php" method="POST" class="was-validated">
   <div class="mb-3 mt-3">
...
where nome_obra IS NULL";
      ...
      if (mysqli_stmt_prepare($stmt, $query)) {
         ...
         if (mysqli_stmt_execute($stmt)) {
            // Bind result variables
            mysqli_stmt_bind_result($stmt, $nome_obra, $nome_beacon, $ref_beacon);
?>
...
?>
             ...
             <br>
   <button href="./scripts/obras/sc_add_obra.php" type="submit" class="btn-definir-obra">Adicionar</button>
